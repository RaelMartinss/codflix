...
export const Banner = () => {
  return (
    <div className='mb-10 lg:mb-20-10'>
      <div className='flex flex-col space-y-4 py-16 md:space-y-4 lg:h-[65vh] lg:justify-end lg:pb-12'>
        ...
        <p className='text-shadow-md max-w-xs md:max-w-lg md:text-lg ld:max-w-2xl'>
          Geralt of Rivia, Solitary moster hunter, struggles to find his
